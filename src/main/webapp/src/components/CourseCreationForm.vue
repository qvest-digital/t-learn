    ...
    <b-form @submit.prevent="create">
      ...
      <div class="mb-3">
        ...
        <b-form-invalid-feedback
          >Titel / Thema ist ein Pflichtfeld.</b-form-invalid-feedback
        >
      </div>
      ...
      <b-row class="mb-3">
        <b-col>
          ...
          />
          <b-form-invalid-feedback
            >Trainer ist ein Pflichtfeld.</b-form-invalid-feedback
          >
        </b-col>
        <b-col>
      ...
      <b-row class="mb-3">
        <b-col>
          ...
          />
          <b-form-invalid-feedback
            >Veranstaltungsart ist ein Pflichtfeld.</b-form-invalid-feedback
          >
        </b-col>
        <b-col>
      ...
      <b-row class="mb-3">
        ...
        <b-col>
          ...
          />
          <b-form-invalid-feedback>
            Der Link muss ein gültiger URL sein und mit den Protokollen "http"
            oder "https" beginnen.
          </b-form-invalid-feedback>
        </b-col>
      </b-row>
